...
try {
    # Using local instance as commonly seen in setup
    ...
    $scriptContent = Get-Content "apps\webapp\DatabaseScripts\Create_UserPageUsage_Table.sql" -Raw
    ...
    Write-Host "UserPageUsage table script applied successfully."
} catch {
