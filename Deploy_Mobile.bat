...
echo $zipName = "GFC_Mobile_Standalone.zip" >> "%PS_PATH%"
...
echo     $staging = "C:\inetpub\PublishGFCMobile" >> "%PS_PATH%"
echo     $live = "C:\inetpub\GFCMobile" >> "%PS_PATH%"
echo     $backupRoot = "C:\inetpub\history_mobile" >> "%PS_PATH%"
...
echo     Write-Step "Stopping IIS (GFCMobile)..." >> "%PS_PATH%"
echo     Import-Module WebAdministration -ErrorAction SilentlyContinue >> "%PS_PATH%"
echo     try { Stop-Website "GFCMobile" ; Stop-WebAppPool "GFCMobile" } catch {} >> "%PS_PATH%"
...
echo     Start-WebAppPool "GFCMobile" ; Start-Website "GFCMobile" >> "%PS_PATH%"
