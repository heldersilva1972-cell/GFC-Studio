...
SELECT 
    ...
    ItemsJson
FROM PosSales
WHERE CAST(Timestamp AS DATE) = '2026-09-17' 
  AND BartenderName = 'JMelanson'
...
Write-Host "Found $($salesList.Count) sales for JMelanson on 2026-09-17."
...
Write-Host "`nCalculated Shift Totals for JMelanson (Night Shift - Sep 17):"
