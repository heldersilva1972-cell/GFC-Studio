...
namespace GFC.Core.Interfaces
{
    ...
    public interface ISystemSettingsService
    {
        ...
        // Management methods
        Task<GFC.Core.Models.SystemSettings> GetAsync();
        Task<GFC.Core.Models.SystemSettings> GetSettingsAsync();
        Task UpdateAsync(GFC.Core.Models.SystemSettings settings);
        Task SaveSettingsAsync(GFC.Core.Models.SystemSettings settings);
    }
}
