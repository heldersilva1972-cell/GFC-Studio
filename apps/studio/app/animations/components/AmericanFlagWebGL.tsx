...
const AmericanFlagWebGL: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // temporary 1x1 blue pixel while image loads
    gl.texImage2D(
      gl.TEXTURE_2D,
      0,
      gl.RGBA,
    ...
    image.onerror = () => {
      console.error("Failed to load flag texture /flags/us-real.png");
    };
...
export default AmericanFlagWebGL;
