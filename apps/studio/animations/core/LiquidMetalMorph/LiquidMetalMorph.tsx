 ...
 * 
 * Technical Breakdown:
 * - Uses Framer Motion's path morphing capabilities
 * - Three SVG path definitions for I, Heart, and U shapes
 * - Animated gradient stops for metallic reflection effect
 * - Smooth bezier curve transitions between shapes
 * - Continuous loop with synchronized timing
 * 
 * SVG Path Plan:
 * - Path 1: Letter "I" (vertical line with serifs)
 * - Path 2: Heart shape (two rounded lobes at top, point at bottom)
 * - Path 3: Letter "U" (curved bottom, vertical sides)
 * 
 * Framer Motion Plan:
 * - Animate path `d` attribute through the three shapes
 * - Animate gradient colors for metallic effect
 * - Use easeInOut for smooth transitions
 * - 4-second cycle per shape transition
 */
