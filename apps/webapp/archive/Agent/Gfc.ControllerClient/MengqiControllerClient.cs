...
using Gfc.ControllerClient.Protocol;
using Gfc.ControllerClient.Services;
using Gfc.ControllerClient.Transport;
using Microsoft.Extensions.Logging;

namespace Gfc.ControllerClient;
...
public sealed class MengqiControllerClient : IMengqiControllerClient, IDisposable
{
    ...
    private async Task SendAndExpectAck(uint controllerSn, WgCommandProfile profile, ReadOnlySpan<byte> payload, CancellationToken cancellationToken)
    {
