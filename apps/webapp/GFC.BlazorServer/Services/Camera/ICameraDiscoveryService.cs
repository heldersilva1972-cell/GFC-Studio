...
namespace GFC.BlazorServer.Services.Camera
{
    ...
    public interface ICameraDiscoveryService
    {
        ...
        Task<List<DiscoveredCamera>> DiscoverCamerasAsync(string networkRange = null, int timeoutSeconds = 30, Action<string> onStatusUpdate = null, Action<DiscoveredCamera> onCameraFound = null);
