...
{
    public partial class AddVideoAccessSecuritySchema : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "VpnSessions");
            migrationBuilder.DropTable(name: "VideoAccessAudit");
            migrationBuilder.DropTable(name: "SecurityAlerts");
            migrationBuilder.DropTable(name: "VpnProfiles");
        }
    }
}
