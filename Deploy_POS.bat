...
echo     $staging = "C:\inetpub\PublishGFCPos" >> "%PS_PATH%"
echo     $live = "C:\inetpub\GFCPos" >> "%PS_PATH%"
echo     $backupRoot = "C:\inetpub\history_pos" >> "%PS_PATH%"
...
echo     Write-Step "Stopping IIS (GFCPos)..." >> "%PS_PATH%"
echo     Import-Module WebAdministration -ErrorAction SilentlyContinue >> "%PS_PATH%"
echo     Stop-Website "GFCPos" -ErrorAction SilentlyContinue >> "%PS_PATH%"
echo     Stop-WebAppPool "GFCPos" -ErrorAction SilentlyContinue >> "%PS_PATH%"
...
echo     Start-WebAppPool "GFCPos" -ErrorAction SilentlyContinue >> "%PS_PATH%"
echo     Start-Website "GFCPos" -ErrorAction SilentlyContinue >> "%PS_PATH%"
