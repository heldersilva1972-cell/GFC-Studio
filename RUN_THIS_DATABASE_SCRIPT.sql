-- =============================================
-- GFC Bartender Schedule - Database Migration
-- Created: 2025-12-23
-- Description: Creates StaffMembers and StaffShifts tables for Bartender Schedule feature
-- =============================================
...
-- Step 4: Insert sample bartenders (OPTIONAL - comment out if not needed)
...
PRINT '3. Navigate to /admin/staff-shifts';
PRINT '========================================';
GO
